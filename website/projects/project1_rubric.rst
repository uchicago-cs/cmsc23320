...
.. note::
    ...
    If you scored two S's in your initial submission for Project 1B, but not in your initial Project 1A
    ...
    skip to "Project 1B Submissions with two S's" below.
...
If you scored two S's in your initial submission for Project 1B, but not in your
...
Note: If you already earned two S's in both Project 1A and 1B, do not make a resubmission
(it will be ignored). If you have questions about any of the feedback you received,
please post a question on Ed.

Submitting
~~~~~~~~~~

You will submit your code through the "Project 1 (Resubmission)" assignment on Gradescope.
Other than that, you should follow the same submission instructions as in the original submissions.
